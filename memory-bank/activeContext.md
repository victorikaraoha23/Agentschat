...
- **Current task:** Task 0.2 (repository foundation) — complete. Task 1.1 **not** started.
- **What was done:**
...
- **Next steps:**
  - Start Task 1.1 only on explicit instruction; read root `AGENTS.md` and the relevant area guides first.
